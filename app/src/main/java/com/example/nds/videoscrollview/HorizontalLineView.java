...
public class HorizontalLineView extends View {
    ...
    public HorizontalLineView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onDraw(Canvas canvas) {
        canvas.drawLine(10, 750, 2700, 750, paintH);
        canvas.drawLine(10, 750, 2700, 750, paintV);
        canvas.drawLine(10, 925, 10, 1075, paintHL);
        canvas.drawLine(300, 750, 300, 900, paintHL);
